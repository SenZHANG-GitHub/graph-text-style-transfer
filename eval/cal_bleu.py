...
dataset_ = 'yelp'
# models = ['GTAE-alfa-20200702-0', 'StyleTransformer-multi', 'DualRL', 'StyleTransformer-cond', 'UnsuperMT_Zhang', 'UnpairedRL_Xu', 'TemplateBase_Li', 'DeleteOnly_Li', 'DeleteRetrieve_Li', 'ca_IMaT', 'IMaT', 'multi_decoder_IMaT', 'Seq2SentiSeq-7', 'Seq2SentiSeq-9', 'Seq2SentiSeq-5', 'Seq2SentiSeq-3' ,'Seq2SentiSeq-1', 'BackTranslation_Pr', 'style_emb_IMaT', 'RetrieveOnly_Li', 'ARAE']
models = ['dar_IMaT', 'StyleEmbedding_Fu', 'Multidecoder_Fu']
